import { HORMONES, HORMONE_BY_ID, GROUPS } from './data.js?v=36';
import { SITUATIONS, SITUATION_BY_ID, CATEGORIES, PHASES, TIMING, COMPARE, DOSE } from './situations.js?v=36';
import { SEXES, AGES, profileFactors, baseline } from './profile.js?v=36';
import {
