import { HORMONES, HORMONE_BY_ID, GROUPS } from './data.js?v=6';
import { SITUATIONS, SITUATION_BY_ID, CATEGORIES, PHASES } from './situations.js?v=6';
import { SEXES, AGES, profileFactors, baseline } from './profile.js?v=6';
import {
