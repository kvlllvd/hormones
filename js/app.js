import { HORMONES, HORMONE_BY_ID, GROUPS } from './data.js?v=7';
import { SITUATIONS, SITUATION_BY_ID, CATEGORIES, PHASES } from './situations.js?v=7';
import { SEXES, AGES, profileFactors, baseline } from './profile.js?v=7';
import {
